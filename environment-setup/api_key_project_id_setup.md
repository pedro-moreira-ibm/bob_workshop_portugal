...
![Agent Lab](assets/agent-lab.png)
...
4. After clicking "Manage Options", the Project ID will be displayed copy Project ID for further use.
   ...
   ![Project ID](assets/click_manage_get_projectId.png)
